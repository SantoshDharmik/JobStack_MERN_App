...
const Header = () => {
    ...
    className="text-white absolute right-2 top-1/2 -translate-y-1/2 
      bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none 
      focus:ring-blue-300 font-medium rounded-lg text-sm px-7 py-1.5 
      dark:bg-blue-600 dark:hover:bg-primary dark:focus:ring-blue-800"
  >
    Search
  </button>
                            </div>
